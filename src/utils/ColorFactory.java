...
public class ColorFactory
{
	...
	/**
	 * Checks if this factory already has the provided color or not
	 * @param color the color to search in the factory
	 * @return true if this color is already in the factory, false otherwise
	 */
	public static boolean hasColor(Color color)
	{
		return colorFactory.has(color);
	}
}
