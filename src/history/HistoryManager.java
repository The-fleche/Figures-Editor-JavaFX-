...
public class HistoryManager<E extends Prototype<E>>
{
	 ...
	 * The Originator should be able to create a {@link Memento} saving its
	 ...
	 * @see #redoStack
	 */
	protected Deque<Memento<E>> undoStack;

	/**
	 * Redo stack
	 * @see #undoStack
	 */
	protected Deque<Memento<E>> redoStack;
	...
	public void record()
	{
		// TODO 605 HistoryManager#record ...
	}

	/**
	 * If {@link #originator} is not null then push {@link #originator} current
	 * state into {@link #redoStack} and pops the last state from
	 * {@link #undoStack} into {@link #originator}.
	...
	/**
	 * If {@link #originator} is not null then push {@link #originator} current
	 * state into {@link #undoStack} and pops the last {@link Memento} from
	 * {@link #redoStack} into {@link #originator}.
	 * @see #pushUndo(Memento)
	 * @see Originator#createMemento()
	 * @see #popRedo()
	 * @see Originator#setMemento(Memento)
	 ...
	 * Memento) to the {@link #undoStack}. If the provided state is null or
	 * identical to the last pushed memento a warning message should be issued
	...
	{
		// TODO 601 HistoryManager#pushUndo ...
		return false;
	}
	...
	protected Memento<E> popUndo()
	{
		...
		// TODO 602 HistoryManager#popUndo ...
	...
	{
		// TODO 603 HistoryManager#pushRedo ...
		return false;
	}
	...
	protected Memento<E> popRedo()
	{
		...
		// TODO 604 HistoryManager#popRedo ...
