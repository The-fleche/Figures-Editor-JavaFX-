...
public class SelectionTool extends FocusedFigureTool
{
	                     ...
	                     Logger parentLogger)
	{
		super(pane,
		      model,
		      CLICKED, //  uses super(...,ENTERED_TARGET|EXITED_TARGET|CLICKED)
		      parentLogger);
	}
	...
	public void mouseClicked(MouseEvent event)
	{
		...
		// SelectionTool#mouseClicked ...
		if (button == MouseButton.PRIMARY)
		{
			if (focusedFigure != null)
			{
				/*
				 * We should modify the selection model
				 */
				drawingModel.updateSelection(drawingModel.indexOf(focusedFigure),
				                             !focusedFigure.isSelected());
			}
		}
	}
}
