...
/**
 * Tool managing cursor entering in or exiting {@link Shape}s drawn in a
 * {@link Pane}.
...
public class FocusedFigureTool extends AbstractDrawingTool<Pane>
{
	                         ...
	                         Logger parentLogger)
	{
		super(pane,		// Drawing Pane to listen for events
		      ...
		      false,	// events are not consumed (no need)
		      parentLogger);
	}
	...
	public void mouseEnteredTarget(MouseEvent event)
	{
		...
		if (target instanceof Shape)
		{
			...
			focusedFigure = drawingModel.fromShape(targetShape); // might be null
		}
	}
